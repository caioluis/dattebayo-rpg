        ...
        <NarrowContainer>
          <div className="flex justify-between m-auto mt-10 h-[180px] xs:h-[260px] s:h-[300px] sm:h-[330px] md:h-[370px] mmd:h-[400px] p-2 xs:p-6 rounded-md z-[1] lg:h-[420px] bg-orange-700 bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10 border border-neutral-800">
            <div className="absolute h-[200px] w-[180px] xs:h-[280px] xs:w-[260px] s:h-[320px] s:w-[300px] sm:h-[350px] sm:w-[330px] md:h-[390px] md:w-[370px] mmd:h-[420px] mmd:w-[400px] lg:h-[440px] lg:w-[420px]  bottom-0  z-[3]  left-[70px] xs:left-[90px] s:left-[140px] sm:left-[170px] md:left-[240px]">
              <Image
                src="https://i.imgur.com/HkfIKQ1.png"
                fill={true}
                alt="Temari"
              />
            </div>
          ...
          <div className="flex justify-between">
            <div className="relative mt-10 h-[180px] xs:h-[260px] s:h-[300px] sm:h-[330px] md:h-[370px] mmd:h-[400px] p-2 xs:p-6 rounded-md z-[1] lg:h-[420px] w-8/12 bg-neutral-1000 bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-70 border border-neutral-800">
              <div className="absolute h-[190px] w-[220px] xs:h-[260px] xs:w-[290px] s:h-[320px] s:w-[350px] sm:h-[350px] sm:w-[380px] md:h-[390px] md:w-[420px] mmd:h-[420px] mmd:w-[450px] lg:h-[440px] lg:w-[470px] z-[3] left-[110px] xs:left-[90px] s:left-[140px] sm:left-[170px] md:left-[240px] bottom-0">
                <Image
                  src="https://i.imgur.com/LRhF1aI.png"
                  fill={true}
                  alt="Hashirama"
                />
              </div>
              ...
              <h3 className="text-orange-400 text-[9px] sm:text-base pb-1">
                X Postagens • X Tópicos
              </h3>
              <p className="relative z-[4] text-[8px] sm:text-base font-medium text-neutral-100 drop-shadow-[0_2px_2px_rgba(0,0,0,1)]">
                Conheça todas as regras e informações úteis para a sua jornada
                como um grande ninja! Um bom conhecimento das regras é vital
                para o bem-estar do RPG.
              </p>
