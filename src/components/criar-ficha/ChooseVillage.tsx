...
const ChooseYourVillage: NextPage = ({ user, setStage }: { user: User | null, setStage: React.Dispatch<React.SetStateAction<number>> }) => {
  ...
  const { mutateAsync: joinVillage, status: joinVillageMutationStatus } =
    trpc.village.joinVillage.useMutation();
  ...
  if (
    ...
    joinVillageMutationStatus == 'loading'
  ) {
    return (
          ...
          return (
            <div className="flex flex-col w-fit" key={village.id}>
                ...
                {village.id === 2 ? (
                  <div className="flex w-full justify-between absolute bottom-1 mb-5 2xl:mb-10">
                    <div className="ml-5">
                      ...
                      <h3 className="text-xl font-medium text-neutral-400 ml-2">
                        Vila da Areia
                      </h3>
                    </div>
                  ...
                  <div className="flex w-full justify-between absolute bottom-1 mb-5 2xl:mb-10">
                    <div className="ml-5">
                      ...
                      <h3 className="text-xl font-medium text-neutral-400 ml-1 2xl:ml-2">
                        Vila da Névoa
                      </h3>
                    </div>
                    <div className="h-[75px] w-[75px] 2xl:h-[100px] 2xl:w-[100px]">
              ...
              <p className="self-center mt-5">
                Vagas restantes: {numberOfVacantSpots}
              </p>
